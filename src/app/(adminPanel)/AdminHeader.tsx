...
const Header = () => {
  ...
  return (
    <>
      <nav className="bg-bg-1 border-light-white sticky top-0 z-50 flex h-screen w-80 min-w-[320px] flex-col justify-between border-r shadow-xl max-lg:hidden">
        {/* Header Top Section */}
        <div className="flex flex-col space-y-6 p-6">
          ...
          <div className="relative">
            <AiOutlineSearch className="text-light-dark absolute top-1/2 left-3 h-5 w-5 -translate-y-1/2 transform" />
            <input
              type="text"
              placeholder="جستجو..."
              className="border-light-white bg-primary-40 text-secondary placeholder:text-light-dark focus:border-accent focus:ring-accent/20 w-full rounded-xl border py-3 pr-4 pl-10 focus:ring-2 focus:outline-none"
            />
          </div>
