...
const QuickActions = () => {
  ...
  return (
    <div className="border-light-white rounded-2xl border p-6 shadow-lg">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-2 2xl:grid-cols-3 items-start gap-3">
        {actions.map((action, index) => (
          ...
          >
            ...
            <div className="border-light-white h-full flex flex-col items-center justify-center hover:bg-primary-40 bg-bg-1 relative rounded-xl border p-4 transition-all duration-300 group-hover:border-transparent group-hover:shadow-xl">
              <div
